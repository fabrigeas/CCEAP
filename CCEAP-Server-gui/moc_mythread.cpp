...
QT_MOC_LITERAL(1, 9, 6), // "signal"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 10) // "stringList"

    },
    "MyThread\0signal\0\0stringList"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyThread::*_t)(QStringList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::signal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyThread::signal(QStringList _t1)
{
